    ...
    const cardRenderers = {
        ...
        graph: {
            ...
            render: (cardElement) => {
                ...
                // OPTIMIZATION: Create a fragment to batch DOM insertions
                ...
                while (currentDate <= examDate) {
                    ...
                    // Optimization: Compare timestamps (numbers) instead of objects
                    ...
                    // Append to fragment instead of graphContainer
                    fragment.appendChild(dayCell);
                    
                    currentDate.setDate(currentDate.getDate() + 1);
                }
                
                // OPTIMIZATION: Only touch the real DOM once
